...
public class Cliente {
    ...
    public RequisicaoPorMesa fazerRequisicaoMesa(int numeroPessoas )
    {
        //Deverá existir um metodo que vai checar se o status da mesa com esse numero de pessoas é true(disponivel) ou false(ocupada)
        if(estaDisponivel())
        {
            System.out.println("Mesa com "+ numeroPessoas + " lugares disponivel!");
        }else
        {
